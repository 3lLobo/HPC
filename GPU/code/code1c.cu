...
void vectorAddCuda(int threadsz, int n, float* a, float* b, float* result) {
    int threadBlockSize = threadsz;
...
int main(int argc, char* argv[]) {
	...
	cout << "Threadsize is " << threadsz << "." << endl;
   	...
   	vectorAddSeq(n, a, b, result_s);
    	vectorAddCuda(threadsz, n, a, b, result);
